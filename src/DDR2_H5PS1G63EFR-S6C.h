 ...
 */
#define DDR_tRAS  8000  /* ACTIVE to PRECHARGE command period to the same bank. */
#define DDR_tRTP  8000  /* READ to PRECHARGE command period. */
#define DDR_tRP   8000  /* PRECHARGE command period to the same bank */
#define DDR_tRCD  8000  /* ACTIVE to READ or WRITE command period to the same bank. */
#define DDR_tRC   8000  /* ACTIVE to ACTIVE command period to the same bank.*/
#define DDR_tRRD  8000  /* ACTIVE bank A to ACTIVE bank B command period. */
#define DDR_tWR   8000  /* WRITE Recovery Time defined by register MR of DDR2 memory */
#define DDR_tWTR  8000  /* WRITE to READ command delay. */

/*
 * DDR2 controller timing2 register
 */
#define DDR_tRFC   64000 /* ps,  AUTO-REFRESH command period. */
#define DDR_tMINSR    138 /* tCK, Minimum Self-Refresh / Deep-Power-Down */
 ...
 */
#define DDR_TSEL   1 /* PHY to DDR transfer delay */

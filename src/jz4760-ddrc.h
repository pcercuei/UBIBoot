#ifndef __JZ4760_DDRC_H__
#define __JZ4760_DDRC_H__
...
#define DDRC_CFG_CS1EN		(1 << 7) /* 0 DDR Pin CS1 un-used
					    1 There is DDR memory connected to CS1 */
#define DDRC_CFG_CS0EN		(1 << 6) /* 0 DDR Pin CS0 un-used
					    1 There is DDR memory connected to CS0 */
...
#define DDR_EMRS1_QOFF			(1<<12)  /* 0 Disable - 1 Enable */
#define DDR_EMRS1_RDQS_EN		(1<<11)  /* 0 Disable - 1 Enable */
#define DDR_EMRS1_DQS_DIS		(1<<10)  /* 0 Enable - 1 Disable */
...
#define DDRC_JZ4760_TIMING2_TRFC_BIT	12 /* AUTO-REFRESH command period. */
#define DDRC_JZ4760B_TIMING2_TRFC_BIT	24 /* AUTO-REFRESH command period. */
#define DDRC_TIMING2_RWCOV_BIT		19 /* Equal to Tsel of MDELAY. */
#define DDRC_TIMING2_RWCOV_MASK		(0x3 << DDRC_TIMING2_RWCOV_BIT)
#define DDRC_TIMING2_TCKE_BIT		16 /* minimum CKE pulse width */

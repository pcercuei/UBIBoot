...
#elif defined(SDRAM_WB9812G6IH_6)
#include "SDR_WB9812G6IH-6.h"
#elif defined(SDRAM_K4S561632H_UC75)
#include "SDR_K4S561632H_UC75.h"
#elif defined(SDRAM_HY57V281620FTP_6)
#include "SDR_HY57V281620FTP_6.h"

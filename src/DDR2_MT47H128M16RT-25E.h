...
#define DDR_tRP   12500  /* PRECHARGE command period to the same bank */
#define DDR_tRCD  12500  /* ACTIVE to READ or WRITE command period to the same bank. */
 ...
 */
#define DDR_tRFC   195000 /* ps,  AUTO-REFRESH command period. */
#define DDR_tMINSR    200 /* tCK, Minimum Self-Refresh / Deep-Power-Down */
